...
class _ResetPasswordPageState extends ConsumerState<ResetPasswordPage>
  ...
  Future<void> _onCodeSubmit() async {
    ...
    final digits = _phoneController.text.replaceAll('-', '');
    try {
      await ref.read(resetPasswordViewModelProvider.notifier).verifyCode(
            phone: digits,
  ...
  Future<void> _onComplete() async {
    ...
    final pw = _passwordController.text;
    try {
      await ref.read(resetPasswordViewModelProvider.notifier).resetPassword(
            phone: digits,
            newPassword: pw,
          );
    } catch (e) {
                          ...
                          StepItem(
                            ...
                            content: PhoneStepContent(
                              ...
                              onResend: () {
                                ...
                                ref
                                    .read(
                                        resetPasswordViewModelProvider.notifier)
                                    .sendCode(phone: digits);
                              },
                            ),
                                ...
                                content: CodeStepContent(
                                  ...
                                  expiresAt: ref.watch(
                                      resetPasswordViewModelProvider
                                          .select((s) => s.codeExpiresAt)),
                                ),
                                statusMessage: _codeCompleted
                                    ? const StepStatusMessage(
                                        text: '인증이 완료되었습니다')
                                    : null,
                              ),
                            ),
