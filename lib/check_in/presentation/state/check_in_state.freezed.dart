...
class _$CheckInStateImpl implements _CheckInState {
  ...
  @override
  String toString() {
    return 'CheckInState(isLoading: $isLoading, todayChecked: $todayChecked, latestCheckedAt: $latestCheckedAt, error: $error)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, todayChecked, latestCheckedAt, error);
